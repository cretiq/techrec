          ...
          >
            <CardContent className="p-4 space-y-4">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-base-content/70">Tone & Style</label>
                <div className="flex gap-2 flex-wrap">
                  {(["friendly", "formal", "enthusiastic"] as const).map((toneOption) => (
                    <Button
                      key={toneOption}
                      variant={tone === toneOption ? "default" : "outline"}
                      size="sm"
                      onClick={() => dispatch(updateCoverLetterTone({ roleId: role.id, tone: toneOption }))}
                      className={cn(
              ...
              {/* Hiring Manager Name */}
              <div className="space-y-2">
                <label htmlFor="hiringManager" className="text-sm font-medium text-base-content/70">
                  Hiring Manager Name
                </label>
                <Input
                  id="hiringManager"
                  ...
                  value={hiringManager}
                  onChange={(e) => dispatch(updateCoverLetterHiringManager({ roleId: role.id, hiringManager: e.target.value }))}
