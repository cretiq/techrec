...
export function AchievementsCard({ profile, initialProfile, onDeleteAchievement }: AchievementsCardProps) {
  return (
    <Card className="border shadow-none bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/30 dark:to-purple-900/30 animate-fade-in-up">
      ...
      <CardContent>
        <div className="space-y-4">
          {(profile?.achievements || initialProfile?.achievements || []).map((achievement) => (
          ...
          {(profile?.achievements || initialProfile?.achievements || []).length === 0 && (
