                ...
                {sections.map(section => (
                    <li key={section.id}>
                        <button 
                            ...
                            className={cn(
                                "w-full text-left px-3 py-1.5 text-sm rounded transition-all duration-100 ease-in-out focus:outline-none focus:ring-2 focus:ring-primary/50 focus:ring-offset-1 cursor-pointer",
